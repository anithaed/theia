...
import { Repository, WorkingDirectoryStatus, Branch, IGitResult, GitError } from './git-model';
...
export interface Git extends Disposable {
     ...
     */
    exec(repository: Repository, args: string[], options?: Git.Options.Execution): Promise<IGitResult>;
